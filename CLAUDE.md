...
- **필요한 경우에만 absolute positioning 사용**: 기본적으로 Flexbox와 Grid를 활용한 레이아웃 구성 (반응형까지 고려하지 않아도 됨)
...
- Flexbox와 Grid를 기본으로 사용하여 레이아웃 구성
...
- **모든 시간은 KST(한국 표준시) 기준으로 계산**
- 시간대 표기 생략 (KST, +9 등의 표기 사용하지 않음)
- 날짜/시간 계산 시 자동으로 KST 기준으로 처리
